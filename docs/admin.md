...
- **仪表盘** `/admin`：稿件总数、待处理数、栏目数、退修模板数、用户角色分布、稿件状态分布、状态看板（可点进筛选）、待处理稿件、最近注册用户、最近处理记录。
...
- 路由：`/api/v1/admin/manuscripts`、`/admin/users`、`/admin/users/recent`、`/admin/actions/recent`、`/admin/sections`、`/admin/templates/revision`、`/admin/config`、`/admin/stats`。
