...
export default function Footer() {
  return (
    <footer className="border-t border-[#dde1e8] bg-white py-10" role="contentinfo">
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        <div className="text-[14px] leading-8 text-[#5f6573]">
        ...
        <nav aria-label="页脚导航" className="mt-5 flex flex-wrap gap-6 text-[15px]">
        ...
        <p className="mt-8 text-center text-sm text-[#8b909b]">版权所有 © 中外法学 · 智能编审系统</p>
      </div>
    </footer>
  );
}
